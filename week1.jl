...
# ╔═╡ 0516401b-aa8e-444b-9a1c-0a7d53e77702
md"""
##### My Examples:
- Numbers
    - Bacterial growth every minute
...
md"""
I do think that `imresize` can create a half sized or smaller image of philip but I do think that there is still significant loss of detail. I mean it is not as losing as much quality as the previous one but, I think there is a better way to do it.
"""

# ╔═╡ 073e078e-7dc4-44c2-a80f-867e8ef87a54
@bind resize Slider(1:10)

# ╔═╡ 7dfbd2dc-4eb8-4a0f-91b8-3ea28fdbbf4a
resized_philip = imresize(philip, ratio=1/resize)
